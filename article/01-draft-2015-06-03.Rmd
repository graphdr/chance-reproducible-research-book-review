...
I have adapted Gandrud's suggested directory structure, for example, to suit my own needs. I have expanded his three basic categories---data, analysis, and presentation---to the directory structure shown below. 
...
Some data scientists recommend that origional or raw data have it own directory top help keep it unaltered in any way. Others recommend that the R scripts for tidying data also have their own directory. 
